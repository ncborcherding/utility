...
for (j in seq_along(tmp)) {
  ...
  saveRDS(com.res1, file = paste0("./annotation/singler/",  samples[i], "_", names(tmp)[j], "_DICE.singler_output.rds"))
...
sing.list <- list.files("./annotation/singler/")
HPCA.ann <- NULL
dice.ann <- NULL
...
pro.list <- list.files("./annotation/projectil/")
proj.annot <- NULL
